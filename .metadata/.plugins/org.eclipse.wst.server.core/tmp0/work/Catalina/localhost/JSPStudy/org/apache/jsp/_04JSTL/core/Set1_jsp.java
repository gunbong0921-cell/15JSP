 ...
 * Generated at: 2026-09-21 06:36:28 UTC
...
public final class Set1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("	<!-- 변수 선언 : 여기서는 가장 좁은 page영역에 저장된다. value에는 일반값, EL, 표현식 모두\r\n");
      out.write("	사용할 수 있다. -->\r\n");
      out.write("	<!-- \r\n");
      out.write("	set 태그\r\n");
      out.write("		: 변수를 선언할때 사용. JSP의 setAttribute() 매서드와 동일하게 4가지 영역에 속성을 저장한다.\r\n");
      out.write("		var : 속성명(변수명) 을 지정\r\n");
      out.write("		value : 속성에 저장할 값\r\n");
      out.write("		scope : 4가지 영역명을 지정. 생략시 가장 좁은 page영역 지정됨.\r\n");
      out.write("		target : set태그를 통해 생성된 자바빈(인스턴스)의 이름 지정.\r\n");
      out.write("		property : target으로 지정한 자바빈의 멤버변수의 값 설정.\r\n");
      out.write("	 -->\r\n");
      out.write("	");
      ...
      try {
        ...
        // /04JSTL/core/Set1.jsp(26,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_c_005fset_005f2.setVar("expVar");
        // /04JSTL/core/Set1.jsp(26,1) name = value type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      ...
      out.write("\r\n");
      out.write("	\r\n");
      out.write("	<!-- 속설명이 중복되지 않는다면 영역을 포시하는 내장객체를 생략할 수 있다. -->\r\n");
      ...
      out.write("	<!-- \r\n");
      out.write("	클래스의 생성자를 통해 인스턴스를 생성한 후 request영역에 저장.\r\n");
      out.write("	 -->\r\n");
      out.write("	");
      //  c:set
      ...
      try {
        ...
        // /04JSTL/core/Set1.jsp(42,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_c_005fset_005f4.setVar("personVar1");
        // /04JSTL/core/Set1.jsp(42,1) name = value type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
        _jspx_th_c_005fset_005f4.setValue( new Person("박문수", 50) );
        // /04JSTL/core/Set1.jsp(42,1) name = scope type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write("\r\n");
      out.write("	<ul>\r\n");
      out.write("		<!-- 자바빈의 getter를 통해 멤버변수의 값을 출력한다. -->\r\n");
      out.write("		<li>이름 : ");
      ...
      out.write("	<!-- \r\n");
      out.write("	초기값이 ㅇ벗는 상태로 인스턴스를 먼저 생성한 후 target, property를 통해 멤버변수의 값을 설정한다. \r\n");
      out.write("	이때는 자바빈의 setter가 사용된다. \r\n");
      out.write("	 -->\r\n");
      out.write("	 <!-- target으로 자바빈을 지정하고, property로 멤버변수를 지정하여 값을 할당한다. -->\r\n");
      out.write("	");
      //  c:set
      ...
      try {
        ...
        // /04JSTL/core/Set1.jsp(56,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_c_005fset_005f5.setVar("personVar2");
        // /04JSTL/core/Set1.jsp(56,1) name = value type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
        _jspx_th_c_005fset_005f5.setValue( new Person() );
        // /04JSTL/core/Set1.jsp(56,1) name = scope type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fset_005f0(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /04JSTL/core/Set1.jsp(24,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setVar("directVar");
      // /04JSTL/core/Set1.jsp(24,1) name = value type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setValue(new org.apache.jasper.el.JspValueExpression("/04JSTL/core/Set1.jsp(24,1) '100'",_jsp_getExpressionFactory().createValueExpression("100",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_c_005fset_005f1(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /04JSTL/core/Set1.jsp(25,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f1.setVar("elVar");
      // /04JSTL/core/Set1.jsp(25,1) name = value type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f1.setValue(new org.apache.jasper.el.JspValueExpression("/04JSTL/core/Set1.jsp(25,1) '${ directVar mod 5 }'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${ directVar mod 5 }",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_c_005fset_005f3(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /04JSTL/core/Set1.jsp(27,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fset_005f6(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /04JSTL/core/Set1.jsp(57,1) name = target type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /04JSTL/core/Set1.jsp(57,1) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f6.setProperty("name");
      // /04JSTL/core/Set1.jsp(57,1) name = value type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f6.setValue(new org.apache.jasper.el.JspValueExpression("/04JSTL/core/Set1.jsp(57,1) '정약용'",_jsp_getExpressionFactory().createValueExpression("정약용",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_c_005fset_005f7(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /04JSTL/core/Set1.jsp(58,1) name = target type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /04JSTL/core/Set1.jsp(58,1) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f7.setProperty("age");
      // /04JSTL/core/Set1.jsp(58,1) name = value type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f7.setValue(new org.apache.jasper.el.JspValueExpression("/04JSTL/core/Set1.jsp(58,1) '60'",_jsp_getExpressionFactory().createValueExpression("60",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
